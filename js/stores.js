(function() {
    infoStores = {
        ...
        "editForma": "<div id='authForm' style='display:none'><div id='bgLogin'></div><div class='login'><label for='inputUser' class='ttl'>Usuário de Rede</label><input type='text' class='form-control' aria-label='joao.silva' id='inputUser'/><label for='inputPw' class='ttl' id='lblPw'>Senha</label><input type='password' class='form-control' id='inputPw'/><hr><button type='button' id='btCancelAuth' class='btn btn-secondary' onclick='cancelAuth()'>Cancelar</button><button type='button' id='btAuth' class='btn btn-primary' onclick='generatePutToken()'>Confirmar</button></div></div><div class='inputsss'> <label for='comment'>ID do Banner:</label> <div class='input-group mb-3'> <div class='input-group-prepend'> <span class='input-group-text preInpur' id='basic-addon1'>ID:</span> </div><input class='form-control inputP' id='idDoBanner' type='text' placeholder=''> </div></div><div class='buttonsss'><input type='button' id='buttEditCons' value='Consultar'></div><div id='outraJossa'></div>",
        "netshoes": {
            "storeid": "L_NETSHOES",
            "banners": {
                "desktop": {
